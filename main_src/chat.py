...
model_google = genai.GenerativeModel(model_name="gemini-pro",
...
def gen_ai(prompt):
    ...
    prompt_parts = [
      ...
      "output: _put(bowl) # Placing the ball on the surface.",
      "input: Set the wood on the table.",
      "output: _put(bowl) # Setting the wood on the table.",
      "input: Position the battery on the shelf.",
      "output: _put(bowl) # Positioning the battery on the shelf.",
      "input: Place the yellow object on the platform.",
      "output: _put(bowl) # Placing the yellow object on the platform.",
      "input: Set down the wood-colored item.",
      "output: _put(bowl) # Setting down the wood-colored item.",
      "input: Position the silver object on the stand.",
      "output: _put(bowl) # Positioning the silver object on the stand.",
      "input: You can see a yellow ball, silver battery, wooden object, white bowl. Move slightly up",
      "output: _move(up) # Moving slightly up.",
      "input: You can see a yellow ball, silver battery, wooden object, white bowl. Move slightly left",
      "output: _move(left) # Moving left.",
      ...
      "input: You can see a yellow ball, silver battery, wooden object, white bowl. Pick up the battery and put it in the bowl",
      "output: _pickup(battery)place(bowl) # Picking up the battery and putting it in the bowl.",
      "input: you can see {'battery': [[139, 315]], 'glue': [[128, 295]], 'lead': [[156, 321]], 'object_1': [[49, 8]]}. pick up battry ",
      "output: _pickup(battery)",
      "input:what is your name , what u do ? ",
      "output: Hello, I am a Robotic arm i dont have a name and I am an AI assistant designed to assist you with your tasks phycially. ",
      "input: Place the ball in box 1.",
      "output:_put(box1) # placing the ball in box 1 ",
      "input:Pick up the red object.",
      "output:_pickup(red) # picking up the red object",
      f"input:{msg} ",
      "output: ",
      ]
    response = model_google.generate_content(prompt_parts)
    #print(response.text)
    #log1(f"")
